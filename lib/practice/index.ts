...
export { jdcReport, nextGrade, PART_NAMES, PART_MAXIMUMS, TOTAL_DARTS } from "./games/jdc-report"
export type { JdcReport, JdcRound, JdcDoubleResult } from "./games/jdc-report"
